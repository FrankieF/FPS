...
bool AGun::GunTrace(FHitResult& Hit, FVector& ShotDirection)
{
	...
	//DrawDebugCamera(GetWorld(), Position, Rotation, 90, 2, FColor::Red, true);
	FCollisionQueryParams Params;
	Params.AddIgnoredActor(this);
	Params.AddIgnoredActor(GetOwner());
	return GetWorld()->LineTraceSingleByChannel(Hit, Position, End, ECollisionChannel::ECC_GameTraceChannel1, Params);
}
